    ...
    const howToPlay =
        <div className='div-contenido'>
            ...
            <div className='modal-mensaje'>
                ...
                <p className='text-message'>Cada vez que un equipo se equivoque en alguna pregunta, aparecerá un contador junto al botón de "Mostrar Respuesta", cuando el contador llegue a 3, la siguiente pregunta que el equipo responda mal, le restará el puntaje. Posteriormente, el contador se reiniciará en 0 y volverá a incrementarse cada vez que el equipo se equivoque en alguna pregunta. ¡Aclaración! Cada equipo tiene su propio contador de respuestas incorrectas, no se pueden mezclar la cantidad de preguntas incorrectas de un equipo con las de otro equipo.</p>
                <p className='text-message'>Hay una opción para "Robar Puntos", la cual solo aparecerá si se deja correr el tiempo y este llega a 0 sin que antes se presione el botón de "Mostrar Respuesta". Solo puede hacer el robo de puntos el equipo que tendrá el siguiente turno y para activarlo, solo se debe pulsar el botón y ya estará implementada dicha funcionalidad. ¡Importante! Cuando el equipo con el turno siguiente activa el robo de puntos, si su respuesta es correcta, se le suman los puntos, pero si es incorrecta, se le restarán los puntos (aunque su contador de preguntas incorrectas todavía no sea 3) y también su contador de preguntas incorrectas se incrementará en 1.</p>
                <p className='text-message'>Si no se activó el robo de puntos, automáticamente se sumarán los puntos al equipo en turno si la respuesta fue correcta pero si fue incorrecta, no se restarán (a menos que el contador de preguntas incorrectas ya sea 3) y se mostrará nuevamente el tablero. Para evitar seleccionar alguna pregunta por accidente al cerrarse la ventana, hay un bloqueo de seguridad de 1 segundo, en el cual no se podrá elegir ninguna pregunta hasta que el siguiente equipo esté en turno.</p>
